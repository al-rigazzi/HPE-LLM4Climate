...
class TestLocationAwareClimateAnalysis(unittest.TestCase):
        ...
        class MockLocationAwareClimateAnalysis:
            ...
            def forward(self, climate_data: torch.Tensor, text_query: str):
                ...
                return {
                    ...
                    'confidence': torch.sigmoid(torch.randn(climate_data.shape[0], 1)),  # Between 0 and 1
                    ...
                    'query': text_query,
                    'risk_confidence': torch.sigmoid(torch.randn(1)).item(),  # Scalar between 0 and 1
                    'overall_confidence': torch.sigmoid(torch.randn(1)).item(),  # Scalar between 0 and 1
    ...
    def test_analyze_location_query(self):
        ...
        required_fields = [
            'query', 'location', 'location_type', 'climate_risk',
            'risk_confidence', 'trend_magnitude', 'overall_confidence',
            'interpretation'
        ]
