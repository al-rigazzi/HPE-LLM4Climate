...
def test_fixed_encoder():
    ...
    if (patch_weight.shape[0] == expected_out_dim and
        patch_weight.shape[1] == expected_in_dim):
    ...
    print(f"   Sample static data: {static_data.shape} (expected {expected_static_channels} channels)")
