#!/usr/bin/env python3
"""
Architecture Diagram Generator for AIFS Multimodal Climate System
...
ax.text(
    8,
    11.5,
    "HPE LLM4Climate: Multimodal Climate-Text Fusion Architecture",
    ha="center",
    va="center",
    fontsize=18,
    fontweight="bold",
...
# =================== INPUT LAYER ===================
ax.text(
    8, 10.5, "Input Layer", ha="center", va="center", fontsize=14, fontweight="bold", color="black"
)
...
# =================== ENCODER LAYER ===================
ax.text(
    8, 5.5, "Encoder Layer", ha="center", va="center", fontsize=14, fontweight="bold", color="black"
)
...
# Save the diagram in the current directory
png_path = output_dir / "multimodal_architecture_diagram.png"
pdf_path = output_dir / "multimodal_architecture_diagram.pdf"
...
print(f"   📄 {pdf_path} (for executives)")
...
print("   • Technical specifications for executive review")
