...
# Save the diagram
plt.tight_layout()
plt.savefig('/Users/arigazzi/Documents/DeepLearning/LLM for climate/HPE-LLM4Climate/multimodal_architecture_diagram.png',
            dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')
plt.savefig('/Users/arigazzi/Documents/DeepLearning/LLM for climate/HPE-LLM4Climate/multimodal_architecture_diagram.pdf',
            dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')

print("✅ Diagram saved as:")
print("   📊 multimodal_architecture_diagram.png (for presentations)")
print("   📄 multimodal_architecture_diagram.pdf (for executives)")
